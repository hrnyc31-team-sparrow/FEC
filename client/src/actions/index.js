import { getProductInfo, getProductList, getReviewMetadata} from '../apiMaster.js';
...
export default { handleProductUpdate, handleProductListUpdate,handleReviewMetadataUpdate };
